...
<template>
  <div class="flex items-center gap-2 w-full h-12 rounded-xl border-2 border-secondary-font bg-white focus-within:ring-2 ring-primary transition-colors p-4">
    <UserIcon
      v-if="(icon === 'UserIcon')"
